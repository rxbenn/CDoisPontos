...
<main>
  ...
  <section id="avaliacoes" class="reviews-section">
    <div class="container">
      ...
      <div class="reviews-highlight animate-soft">
        <div class="reviews-highlight-inner">
          <div class="reviews-highlight-score">
            <span class="reviews-score-number">4.5</span>
            <span class="reviews-score-max">/5</span>
          </div>
          <div class="reviews-highlight-stars">
      ...
      <div class="row g-3 g-lg-4 mt-2 justify-content-center">
        ...
        <div class="col-md-6 col-lg-4 animate-soft">
          <article class="review-card h-100">
            <div class="review-card-header">
              <div class="review-avatar">J</div>
              <div>
                <div class="review-name">Jorge Piedade</div>
                <div class="review-stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
              </div>
            </div>
            <p class="review-text">"Atendimento simpático, pontual nas entregas das encomendas, preços muito convidativos, adorei, é cinco estrelas."</p>
            <div class="review-source">
              <svg class="google-g-icon" viewBox="0 0 24 24" width="14" height="14" xmlns="http://www.w3.org/2000/svg"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>
        ...
        <div class="col-md-6 col-lg-4 animate-soft">
          <article class="review-card h-100">
            <div class="review-card-header">
              ...
              <div>
                <div class="review-name">Alexandre Barreto</div>
                <div class="review-stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
              </div>
            </div>
            <p class="review-text">"Utilizei como Ponto de Coleta da transportadora GLS e foi prático e rápido. O atendimento é ótimo além dos equipamentos e suprimentos de informática disponíveis."</p>
            <div class="review-source">
              <svg class="google-g-icon" viewBox="0 0 24 24" width="14" height="14" xmlns="http://www.w3.org/2000/svg"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>
              <span class="ms-1">Google</span>
            </div>
        ...
        <div class="col-md-6 col-lg-4 animate-soft">
          <article class="review-card h-100">
            <div class="review-card-header">
              <div class="review-avatar">A</div>
              <div>
                <div class="review-name">Adriana Carvalho</div>
                <div class="review-stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
              </div>
            </div>
            <p class="review-text">"Um excelente atendimento."</p>
            <div class="review-source">
              <svg class="google-g-icon" viewBox="0 0 24 24" width="14" height="14" xmlns="http://www.w3.org/2000/svg"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>
              <span class="ms-1">Google</span>
            </div>
      ...
      <div class="text-center mt-5">
        <a href="https://www.google.com/maps/place/CDoisPontos+Amorosa,+Lda./@41.644858,-8.819453,17z/data=!4m8!3m7!1s0xd25b5e96f497cdf:0x334ec8653e63d143!8m2!3d41.644858!4d-8.819453!9m1!1b1!16s" target="_blank" rel="noopener noreferrer" class="btn-hero-main animate-soft">
          <svg class="google-g-icon" viewBox="0 0 24 24" width="18" height="18" xmlns="http://www.w3.org/2000/svg"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>
  ...
  <!-- VISITE-NOS -->
  <section id="visite-nos" class="visit-section">
    <div class="container">
      <div class="visit-card animate-soft">
        <div class="row g-0 align-items-center">
          <div class="col-lg-6 order-1 order-lg-1">
            <div class="visit-info">
              <div class="visit-opening">
                <i class="bi bi-clock-fill"></i> Aberto todos os dias úteis
              </div>
              <h2 class="visit-title">Visite a nossa loja</h2>
              <p class="visit-text">
                Estamos na Praia da Amorosa, prontos para o ajudar em tudo o que precisa na área da tecnologia. Desde <strong>reparações</strong> a <strong>aconselhamento</strong>, aqui encontra um <strong>atendimento próximo</strong> e soluções rápidas e fiáveis.
              </p>
              <div class="visit-actions">
                <a href="#localizacao-contactos" class="btn-hero-main">
                  <i class="bi bi-geo-alt-fill me-1"></i> Como chegar
                </a>
                <a href="https://wa.me/351939982878" target="_blank" class="btn-visit-secondary">
                  <i class="bi bi-whatsapp me-1"></i> Falar connosco
                </a>
              </div>
            </div>
          </div>
          <div class="col-lg-6 order-2 order-lg-2">
            <div class="visit-image-container">
              <img src="imagens/loja cdoispontos.png" alt="Loja CDoisPontos na Praia da Amorosa" class="visit-image" loading="lazy">
            </div>
          </div>
        </div>
      </div>
